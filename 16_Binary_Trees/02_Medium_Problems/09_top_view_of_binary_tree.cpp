...
// First solve vertical order traversal. Here the answer is the firsst element of each coloumn in vertical order traversal. So just store the first value for each colIndex
