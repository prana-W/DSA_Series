...
int main() {
  ...
  //? We have assumed that the maximum query number will be 12. So we make an array for size 13 (for 0 - 12 queries)
...
//! Therefore, if the number of queries is very large, this method fails and is not efficient.